...
var (
	ErrRoomClosed               = errors.New("error.roomClosed")
	ErrParticipantSessionClosed = errors.New("error.participantSessionClosed")
	ErrPermissionDenied         = errors.New("error.noRoomPermission")
	ErrMaxParticipantsExceeded  = errors.New("error.maxParticipantsExceeded")
	ErrLimitExceeded            = errors.New("error.limitExceeded")
	ErrAlreadyJoined            = errors.New("error.alreadyJoined")
	ErrDataChannelUnavailable   = errors.New("error.dataChannelUnavailable")
	ErrDataChannelBufferFull    = errors.New("error.dataChannelBufferFull")
