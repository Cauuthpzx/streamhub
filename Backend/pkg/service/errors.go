...
var (
	...
	// User auth errors
	ErrUserAlreadyExists  = psrpc.NewErrorf(psrpc.AlreadyExists, "username already exists")
	ErrUserNotFound       = psrpc.NewErrorf(psrpc.NotFound, "user not found")
	ErrInvalidCredentials = psrpc.NewErrorf(psrpc.Unauthenticated, "invalid username or password")
	ErrUsernameEmpty      = psrpc.NewErrorf(psrpc.InvalidArgument, "username cannot be empty")
	ErrPasswordEmpty      = psrpc.NewErrorf(psrpc.InvalidArgument, "password cannot be empty")
	ErrUsernameTooShort   = psrpc.NewErrorf(psrpc.InvalidArgument, "username is too short")
	ErrPasswordTooShort   = psrpc.NewErrorf(psrpc.InvalidArgument, "password is too short")
	ErrUserAuthNotEnabled    = psrpc.NewErrorf(psrpc.FailedPrecondition, "user authentication is not enabled")
	ErrRoomPasswordRequired  = psrpc.NewErrorf(psrpc.Unauthenticated, "room password is required")
	ErrRoomPasswordIncorrect = psrpc.NewErrorf(psrpc.Unauthenticated, "incorrect room password")
	ErrRoomNameEmpty         = psrpc.NewErrorf(psrpc.InvalidArgument, "room name cannot be empty")
)
