  ...
  <div class="bg-white dark:bg-gray-800 border-t border-gray-200/70 dark:border-gray-700 shadow-bar dark:shadow-bar h-bar flex items-center justify-center">
    <div class="flex items-center justify-center gap-2">
      ...
      <AppTooltip :content="micEnabled ? t('chat.muteMic') : t('chat.unmuteMic')" position="top">
        ...
        >
          <SvgIcon v-if="micEnabled" name="mic" :size="16" :stroke-width="1.8" class="text-emerald-500" />
      ...
      <AppTooltip :content="camEnabled ? t('chat.camOff') : t('chat.camOn')" position="top">
        ...
        >
          <SvgIcon v-if="camEnabled" name="video" :size="16" :stroke-width="1.8" class="text-blue-500" />
      ...
      <AppTooltip :content="t('chat.shareScreen')" position="top">
        ...
        >
          <SvgIcon v-if="!screenEnabled" name="monitor-up" :size="16" :stroke-width="1.8" class="text-violet-500" />
      ...
      <AppTooltip :content="t('chat.raiseHand')" position="top">
        ...
        >
          <SvgIcon name="hand" :size="16" :stroke-width="1.8" class="text-amber-500" />
        </button>
      </AppTooltip>
      ...
      <div class="relative">
        <AppTooltip :content="t('chat.reactions')" position="top">
          ...
          >
            <SvgIcon name="smile" :size="16" :stroke-width="1.8" class="text-yellow-500" />
          </button>
        </AppTooltip>
      ...
      <AppTooltip :content="t('chat.panel')" position="top">
        ...
        >
          <SvgIcon name="message-square" :size="16" :stroke-width="1.8" class="text-indigo-500" />
          <span
