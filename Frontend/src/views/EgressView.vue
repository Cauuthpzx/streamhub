...
<template>
 ...
 >
 <SvgIcon v-if="starting" name="loader-circle" :size="16" themed />
 <SvgIcon v-else name="circle" :size="16" themed />
 ...
 <SvgIcon name="circle" :size="48" themed />
 ...
 <SvgIcon v-if="isStoppable(item.status)" name="circle" :size="12" themed />
 ...
 >
 <SvgIcon name="square" :size="14" themed />
 {{ t('egress.stop') }}
 </button>
 </div>
 </div>
