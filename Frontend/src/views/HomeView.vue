...
<template>
 ...
 >
 <SvgIcon name="refresh-cw" :size="14" themed />
 {{ t('room.refresh') }}
 </button>
 <button
 ...
 >
 <SvgIcon name="plus" :size="14" themed />
 {{ t('room.newRoom') }}
 </button>
 </div>
 </div>
 ...
 <SvgIcon name="door-open" :size="48" themed />
 ...
 <SvgIcon name="users" :size="12" themed />
 ...
 >
 <SvgIcon name="log-in" :size="14" themed />
 {{ t('room.join') }}
 </button>
